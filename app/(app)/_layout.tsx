...
import { TrickDeletionProvider } from "../../context/TrickDeletionContext";
              ...
              >
                {navItems.map((item) => (
                  <StyledTouchableOpacity
                    ...
                    className="px-3 py-1"
                    style={{
                      // Aplicar opacidad solo si NO es el botón especial (varita)
                      opacity: item.special
                        ? 1
                        : getActiveRoute() === item.id
                        ? 1
                        : 0.6,
                      ...(item.special
                        ? {
